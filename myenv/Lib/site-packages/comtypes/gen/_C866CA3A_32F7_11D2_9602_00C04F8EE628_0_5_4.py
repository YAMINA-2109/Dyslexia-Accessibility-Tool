...
__all__ = [
    ...
    'DISPID_SPCPhoneToId', 'eLEXTYPE_PRIVATE6', 'SITooSlow',
    'DISPID_SRCResume', 'DISPID_SRCERequestUI',
    'DISPID_SpeechRecoResult', 'DISPID_SDKDeleteKey',
    'DISPID_SVAudioOutput', 'ISpeechGrammarRules',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SINoise',
    'Speech_Max_Pron_Length', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SWFESamplesPerSec', 'eLEXTYPE_RESERVED10',
    'DISPID_SPARecoResult', 'SP_VISEME_10',
    'SAFTCCITT_ALaw_44kHzStereo', 'SPDKL_LocalMachine',
    'DISPID_SRCState', 'SAFT22kHz16BitMono',
    'DISPID_SRGCmdSetRuleState', 'SPXRO_Alternates_SML',
    'SPSHT_EMAIL', 'SVP_12', 'SpTextSelectionInformation', 'ISpVoice',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SLWLangId', 'ISpObjectToken',
    'DISPID_SVSyncronousSpeakTimeout', 'SVP_10',
    'DISPID_SRRDiscardResultInfo', 'SAFT48kHz16BitStereo',
    'DISPID_SVESentenceBoundary', 'DISPID_SGRName', 'SFTSREngine',
    'STSF_CommonAppData', 'DISPID_SPRsCount',
    'DISPID_SDKSetLongValue', 'DISPID_SLPsCount',
    'DISPID_SRGRecoContext', 'ISpeechLexiconWords',
    'SVEStartInputStream', 'DISPID_SPPFirstElement',
    'DISPID_SVStatus', 'SPEI_RESERVED6', 'SpeechMicTraining',
    'DISPID_SDKGetStringValue', 'SVP_1', 'SGSExclusive',
    'SpNotifyTranslator', 'DISPID_SpeechGrammarRules',
    'DISPID_SRGIsPronounceable', 'SAFTCCITT_uLaw_22kHzMono',
    'SRAONone', 'SPSTREAMFORMATTYPE', 'SPSHORTCUTTYPE',
    'DISPID_SPILanguageId', 'SPEI_PROPERTY_NUM_CHANGE',
    'ISpeechGrammarRuleStateTransitions', 'SpeechRecoEvents',
    'SAFTText', 'SP_VISEME_5', 'SAFT32kHz16BitStereo',
    'DISPID_SVEEnginePrivate', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SpeechEngineProperties', 'SPWAVEFORMATTYPE',
    'ISpPhoneticAlphabetConverter', 'DISPID_SLPs_NewEnum',
    'SpeechTokenKeyAttributes', 'eLEXTYPE_PRIVATE4',
    'ISpPhoneticAlphabetSelection', 'SPEI_SOUND_START',
    'SPFM_NUM_MODES', 'ISpeechPhraseReplacements', 'SPLO_STATIC',
    'SPINTERFERENCE_LATENCY_WARNING', 'SAFT22kHz8BitMono',
    'DISPID_SRSClsidEngine', 'SREInterference',
    'DISPID_SRCCreateGrammar', 'SPPS_RESERVED3', 'DISPID_SpeechAudio',
    'SpeechAddRemoveWord', 'SpeechDiscardType', 'SPSEMANTICERRORINFO',
    'STSF_FlagCreate', 'DISPID_SGRId', 'ISpSerializeState',
    'DISPID_SPRuleChildren', 'DISPID_SAFSetWaveFormatEx',
    'ISpeechPhraseInfoBuilder', 'DISPID_SMSADeviceId',
    'DISPID_SRDisplayUI', 'DISPID_SPPId', 'DISPID_SPEPronunciation',
    'SVSFParseAutodetect', 'DISPID_SRRGetXMLResult',
    ...
    'SPPHRASERULE', 'SPRECOCONTEXTSTATUS', 'DISPID_SPRuleConfidence',
    'SpCustomStream', 'SPRULE', 'SPEI_MAX_SR', 'SPRS_INACTIVE',
    'DISPID_SRCEAudioLevel', 'DISPID_SGRSTs_NewEnum', 'SVP_8',
    'SAFT12kHz8BitMono', 'SpeechTokenKeyUI', 'SPPS_NotOverriden',
    'DISPID_SABIBufferSize', 'DISPID_SGRSTText',
    'DISPID_SREmulateRecognition', 'SVP_17', 'DISPID_SRIsShared',
    'SWPUnknownWordPronounceable', 'DISPID_SpeechPhraseElements',
    'SpeechPropertyResourceUsage', 'SVSFParseMask',
    'eLEXTYPE_PRIVATE11', 'DISPID_SGRsCount',
    'DISPID_SpeechVoiceEvent', 'DISPID_SAFType',
    'SpCompressedLexicon', 'SAFT8kHz16BitStereo', 'SP_VISEME_16',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SRRTOffsetFromStart',
    'SRSInactive', 'DISPID_SRAudioInput', 'ISpRecognizer3',
    'DISPIDSPTSI_SelectionLength', 'SPSMF_UPS',
    'DISPID_SVIsUISupported', 'DISPID_SDKEnumValues',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SPCIdToPhone',
    'SAFT44kHz16BitMono', 'eWORDTYPE_ADDED',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPPS_Noncontent', 'DISPID_SAEventHandle',
    'DISPID_SASNonBlockingIO', 'DISPID_SRSetPropertyString',
    'SpeechAudioFormatType', 'ISpeechObjectTokenCategory',
    'SVEBookmark', 'SGDSActive', 'DISPID_SRRRecoContext',
    'SPWORDPRONOUNCEABLE', 'SpeechDataKeyLocation',
    'DISPID_SLGenerationId', 'ISpeechBaseStream',
    'SECFNoSpecialChars', 'SPVPRI_NORMAL',
    'SpPhoneticAlphabetConverter', 'DISPID_SPRulesCount',
    'ISpeechXMLRecoResult', 'SP_VISEME_15', 'DISPID_SVWaitUntilDone',
    'DISPID_SRAudioInputStream', 'SECFDefault',
    'ISpeechPhraseProperty', 'ISpeechAudio', 'SAFT24kHz8BitMono',
    'DISPID_SLAddPronunciationByPhoneIds', 'SAFTCCITT_ALaw_22kHzMono',
    'SPCT_SUB_DICTATION', 'DISPID_SPRsItem', 'SP_VISEME_6',
    'DISPID_SVResume', 'DISPID_SPELexicalForm',
    'DISPID_SpeechAudioFormat', 'SLODynamic',
    'DISPID_SVSInputWordPosition', 'SREHypothesis', 'eLEXTYPE_APP',
    'DISPID_SGRSRule', 'SSSPTRelativeToCurrentPosition',
    'SpeechDictationTopicSpelling', 'DISPID_SPRuleFirstElement',
    'DISPID_SBSSeek', 'DISPID_SBSFormat', 'DISPID_SGRSTPropertyName',
    'DISPID_SPIRule', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SpeechRecoResult2', 'SPINTERFERENCE_NOSIGNAL',
    'SSFMOpenReadWrite', 'eLEXTYPE_PRIVATE19', 'LONG_PTR',
    'DISPID_SVSkip', 'SpeechPropertyAdaptationOn', 'SPEI_MIN_SR',
    'DISPID_SRRPhraseInfo', 'SpeechVoiceSpeakFlags', 'SDTLexicalForm',
    'SpObjectTokenCategory', 'SpeechAudioFormatGUIDText',
    'DISPID_SPRuleParent', 'DISPID_SGRsDynamic',
    'SpStreamFormatConverter', 'SAFT11kHz8BitMono',
    'DISPID_SOTs_NewEnum', 'SpeechEngineConfidence', 'SPAUDIOSTATUS',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SRGDictationLoad', 'SpResourceManager',
    'DISPID_SRRGetXMLErrorInfo', 'SVP_9',
    'DISPID_SRSNumberOfActiveRules', 'ISpeechResourceLoader',
    'DISPID_SpeechPhraseRules', 'DISPID_SLGetPronunciations',
    'SDKLDefaultLocation', 'SpeechTokenContext', 'SP_VISEME_13',
    'ISpeechRecoResultTimes', 'DISPID_SVSInputSentenceLength',
    'DISPID_SDKOpenKey', 'SSFMCreate', 'SECLowConfidence',
    'SPBOOKMARKOPTIONS', 'STCAll', 'DISPID_SRGDictationUnload',
    'SP_VISEME_9', 'SVEPhoneme', 'SAFTCCITT_ALaw_22kHzStereo',
    'SPDKL_CurrentConfig', 'ISpRecognizer', 'SVP_14',
    'SPEI_RESERVED3', 'SPRST_NUM_STATES', 'DISPID_SVEAudioLevel',
    'DISPID_SOTCEnumerateTokens', 'SPAR_High', 'DISPID_SPRText',
    'DISPID_SABIEventBias', 'SRESoundEnd', 'SP_VISEME_17',
    'SpeechRuleState', 'DISPID_SGRSAddWordTransition', 'SDTRule',
    'SPAUDIOOPTIONS', 'SPTEXTSELECTIONINFO', 'DISPID_SMSAMMHandle',
    'DISPID_SRCSetAdaptationData', 'SPWORDLIST', 'SVPAlert',
    'SpeechGrammarState', 'DISPID_SRCEEnginePrivate', 'SpFileStream',
    'DISPID_SABufferInfo', 'IStream', 'SAFT22kHz8BitStereo',
    'SREBookmark', 'SpMMAudioEnum', 'SDTAll', 'SVSFVoiceMask',
    'SPVOICESTATUS', 'SREAllEvents', 'DISPIDSPRG',
    'DISPID_SVPriority', 'DISPID_SGRsFindRule',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SLWPronunciations',
    'SpMMAudioOut', 'DISPID_SpeechBaseStream',
    'SPEI_PROPERTY_STRING_CHANGE', 'SVSFPersistXML',
    'SSFMCreateForWrite', 'SAFTCCITT_ALaw_8kHzMono', 'SSTTTextBuffer',
    'SVEAllEvents', 'SVPNormal', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SGRSTWeight', 'DISPID_SGRSTNextState', 'ISpRecoContext',
    'ISpRecoGrammar2', 'DISPID_SpeechRecognizer',
    'DISPID_SpeechFileStream', 'SPRECORESULTTIMES',
    'SAFT24kHz16BitStereo', 'DISPID_SPCLangId', 'DISPID_SGRsCommit',
    'DISPID_SPIGrammarId', 'DISPID_SLWsItem', 'SAFT44kHz8BitStereo',
    'eLEXTYPE_PRIVATE7', 'SVP_11', 'SVSFlagsAsync', 'DISPID_SRStatus',
    'DISPID_SRCCreateResultFromMemory', 'eLEXTYPE_PRIVATE5',
    'DISPID_SpeechLexiconProns', 'DISPID_SLWWord',
    'DISPID_SVSPhonemeId', 'DISPID_SRCEHypothesis',
    'DISPID_SDKGetBinaryValue', 'SPEVENT', 'SBONone', 'SVF_Emphasis',
    'DISPID_SOTCDefault', 'SPEI_REQUEST_UI', 'SAFTADPCM_8kHzStereo',
    'DISPID_SPEAudioSizeBytes', 'SPBINARYGRAMMAR', 'SP_VISEME_14',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SPPHRASEREPLACEMENT',
    'ISpeechCustomStream', 'DISPID_SRCEEndStream',
    'DISPID_SPIGetText', 'SGRSTTEpsilon', 'DISPID_SVPause',
    'SGRSTTRule', 'DISPID_SPRuleName', 'SAFTCCITT_uLaw_8kHzMono',
    'IEnumString', 'DISPID_SPERequiredConfidence', 'DISPID_SPPParent',
    'DISPID_SpeechPhraseElement', 'ISpeechPhoneConverter',
    'DISPID_SLWsCount', 'DISPID_SLPType', 'eLEXTYPE_PRIVATE20',
    'DISPID_SRGState', 'SpeechRuleAttributes', 'DISPID_SRGCommit',
    'SWTDeleted', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SRSSupportedLanguages', 'ISpEventSink',
    'DISPID_SpeechPhraseProperty', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SpeechAudioState', 'SpeechWordPronounceable',
    'SPEI_TTS_BOOKMARK', 'eLEXTYPE_RESERVED6',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SpeechVoice',
    'DISPID_SRGetPropertyString', 'SGPronounciation',
    'SPRST_INACTIVE', 'SPINTERFERENCE_TOOLOUD', 'SVEViseme',
    'DISPID_SOTCreateInstance', 'SpSharedRecognizer', 'SPEI_VISEME',
    'SVSFNLPSpeakPunc', 'SAFT8kHz8BitMono', 'ISpeechFileStream',
    'DISPID_SRRTimes', 'SSTTWildcard', 'SPXMLRESULTOPTIONS',
    'SPWORDTYPE', 'DISPID_SpeechPhoneConverter',
    'DISPID_SGRSTransitions', 'SPEI_RESERVED2',
    'DISPID_SpeechGrammarRuleStateTransitions', 'ISpeechRecoContext',
    'SPLO_DYNAMIC', 'SPSInterjection', 'SPSHORTCUTPAIRLIST',
    'DISPID_SPAsCount', 'ISpeechPhraseRule', 'SPEI_SOUND_END',
    'SVF_None', 'DISPID_SPRs_NewEnum', 'SAFTADPCM_44kHzStereo',
    'SAFTExtendedAudioFormat', 'DISPID_SRCEBookmark', 'SVP_15',
    'SASClosed', 'DISPID_SRCVoicePurgeEvent', 'DISPID_SRGReset',
    'SAFT48kHz16BitMono', 'STSF_AppData', 'DISPID_SRGId',
    'DISPID_SVSpeakStream', 'eLEXTYPE_USER', 'SVP_21',
    'DISPID_SRSetPropertyNumber', 'eLEXTYPE_PRIVATE10', 'SVP_19',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SPIElements',
    'DISPID_SRCERecognizerStateChange',
    'SpeechPropertyNormalConfidenceThreshold',
    'SPINTERFERENCE_TOOFAST', 'SPEI_SR_BOOKMARK', 'SASPause',
    'SPVPRIORITY', 'SPSEMANTICFORMAT', 'DISPID_SMSGetData',
    'SPPS_Modifier', 'SVESentenceBoundary', 'SAFTADPCM_11kHzStereo',
    'DISPID_SVEBookmark', 'SPWT_LEXICAL', 'SAFTDefault',
    'SPGRAMMARWORDTYPE', 'ISpShortcut', 'SAFT11kHz8BitStereo',
    'SpeechGrammarTagUnlimitedDictation', 'SRERecoOtherContext',
    'SAFT12kHz8BitStereo', 'SPRS_ACTIVE', 'SPSHORTCUTPAIR',
    'SDKLCurrentUser', 'SP_VISEME_0', 'SRARoot', 'ISequentialStream',
    'ISpMMSysAudio', 'SPGS_ENABLED', 'SPPHRASE', 'SPRECOSTATE',
    'SPWF_INPUT', 'eLEXTYPE_PRIVATE17', 'SPEI_RESERVED1',
    'SECNormalConfidence', 'SRTAutopause',
    'SpeechStreamSeekPositionType', 'SDKLLocalMachine', 'ISpPhrase',
    'DISPID_SOTGetDescription', 'DISPID_SRGCmdSetRuleIdState',
    'SPSVerb', 'SRSInactiveWithPurge', 'eLEXTYPE_PRIVATE12',
    'eLEXTYPE_RESERVED4', 'SECHighConfidence',
    'DISPIDSPTSI_ActiveOffset', 'SPSFunction', 'SITooQuiet', 'SVP_3',
    'ISpeechLexiconPronunciations', 'DISPID_SASCurrentDevicePosition',
    'SAFTADPCM_22kHzMono', 'SpeechPropertyLowConfidenceThreshold',
    'SpNullPhoneConverter', 'DISPID_SPIStartTime',
    'DISPID_SVSVisemeId', 'DISPID_SpeechVoiceStatus', 'SP_VISEME_18',
    'DISPID_SPIEngineId', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SLPLangId', 'SPCT_SUB_COMMAND', 'SPRECOGNIZERSTATUS',
    'DISPID_SOTId', 'DISPID_SRGRules', 'SPEI_WORD_BOUNDARY',
    'DISPID_SpeechWaveFormatEx', 'SVSFParseSsml',
    'Speech_StreamPos_Asap', 'ISpeechObjectToken', 'DISPID_SGRClear',
    'DISPID_SLPSymbolic', 'SPPS_Unknown', 'SITooFast', 'WAVEFORMATEX',
    'eLEXTYPE_USER_SHORTCUT', 'SDTReplacement', 'SPSHT_OTHER',
    'SPFM_OPEN_READONLY', 'SVP_4', 'SREPropertyStringChange',
    'SREPropertyNumChange', 'SINoSignal', 'SVP_2',
    'ISpeechLexiconWord', 'DISPID_SPPValue', 'SDTProperty',
    'DISPID_SVVolume', 'SGDisplay', 'SPAR_Medium',
    'DISPID_SRCRecognizer', 'DISPID_SVGetAudioOutputs',
    'SAFT24kHz8BitStereo', 'SAFTGSM610_11kHzMono', 'SLOStatic',
    'DISPID_SGRAddResource', 'SPSSuppressWord', 'DISPID_SLGetWords',
    'SPEI_TTS_AUDIO_LEVEL', 'SPSMF_SAPI_PROPERTIES',
    'SPEI_INTERFERENCE', 'SP_VISEME_21', 'SpeechUserTraining',
    'DISPID_SVRate', 'DISPID_SRCRequestedUIType', 'SPLEXICONTYPE',
    'SVEVoiceChange', 'SRESoundStart', 'SpeechVisemeType',
    'DISPID_SpeechLexicon', 'Speech_StreamPos_RealTime',
    'DISPID_SRRAudio', 'eLEXTYPE_PRIVATE3', 'SAFT48kHz8BitStereo',
    'SDA_Two_Trailing_Spaces', 'DISPID_SGRAttributes', 'SRTEmulated',
    'ISpeechAudioBufferInfo', 'SPEI_MAX_TTS', 'SPEI_RESERVED5',
    'SP_VISEME_12', 'DISPID_SPEsCount', 'DISPID_SWFEChannels',
    'SSSPTRelativeToEnd', 'eLEXTYPE_PRIVATE1', 'ISpDataKey',
    'DISPID_SLWs_NewEnum', 'DISPID_SLAddPronunciation',
    'DISPID_SGRSTsItem', 'SpPhoneConverter', 'SAFT11kHz16BitMono',
    'SDA_Consume_Leading_Spaces', 'DISPID_SRProfile',
    'ISpeechPhraseAlternates', 'SPPARTOFSPEECH',
    'SVSFPurgeBeforeSpeak', 'SRTExtendableParse',
    '_ISpeechVoiceEvents', 'DISPID_SOTsCount',
    'DISPID_SPRDisplayAttributes', 'SVSFIsFilename',
    'DISPID_SWFEBitsPerSample', 'ISpNotifyTranslator',
    'DISPID_SDKGetlongValue', 'SDA_No_Trailing_Space',
    'DISPID_SOTCGetDataKey', 'DISPID_SGRSTPropertyId',
    'DISPID_SASState', 'ISpeechLexiconPronunciation',
    'DISPID_SRRSetTextFeedback', 'DISPID_SWFEBlockAlign',
    'DISPID_SGRSTPropertyValue', 'SPAS_STOP',
    'SpeechEmulationCompareFlags', 'SPFM_CREATE',
    'DISPID_SpeechPhraseReplacements', 'ISpRecoContext2',
    'SpeechGrammarTagDictation', 'DISPID_SRRSaveToMemory',
    'DISPID_SPPsCount', 'SPCT_COMMAND', 'SBOPause', 'ISpNotifySource',
    'SAFT48kHz8BitMono', 'SPEI_RECO_STATE_CHANGE', 'SVP_6',
    'eLEXTYPE_MORPHOLOGY', 'ISpeechMMSysAudio', 'SpeechFormatType',
    'DISPID_SOTCSetId', 'IInternetSecurityMgrSite',
    'DISPID_SRRTStreamTime', 'SVEEndInputStream', 'SVP_13',
    'DISPID_SRSCurrentStreamPosition', 'SPPS_RESERVED2',
    'DISPID_SOTGetAttribute', 'SPAO_NONE',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SRGetPropertyNumber', 'SDA_One_Trailing_Space',
    'SPINTERFERENCE_TOOQUIET', 'eWORDTYPE_DELETED', 'SPEI_SR_PRIVATE',
    'SPSERIALIZEDPHRASE', 'SPINTERFERENCE_NONE',
    'SpeechDisplayAttributes', '_ISpeechRecoContextEvents',
    'ISpRecoGrammar', 'ISpObjectTokenCategory', 'SpAudioFormat',
    'SAFTCCITT_uLaw_8kHzStereo', 'SSTTDictation', 'SpStream',
    'SRAImport', 'SAFT12kHz16BitMono',
    'DISPID_SRGCmdLoadFromResource', 'SpeechVisemeFeature',
    'SAFT32kHz8BitMono', 'DISPID_SPIGetDisplayAttributes',
    'SRCS_Disabled', 'SpPhraseInfoBuilder', 'DISPID_SVVoice',
    'SPGRAMMARSTATE', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'ISpeechVoice', 'ISpeechLexicon', 'DISPID_SpeechPhraseRule',
    'SPLOADOPTIONS', 'SGSEnabled', 'SPAUDIOSTATE', 'SVSFDefault',
    '_SPAUDIOSTATE', 'tagSPPROPERTYINFO', 'SPAR_Unknown',
    'ISpRecoCategory', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SRGSetTextSelection', 'SPEI_RECOGNITION',
    'DISPID_SVEViseme', 'SPRS_ACTIVE_USER_DELIMITED',
    'ISpeechMemoryStream', 'SREAdaptation',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'eLEXTYPE_PRIVATE9',
    'SpeechCategoryVoices', 'SITooLoud', 'SPSUnknown', 'SPPS_LMA',
    'DISPID_SAVolume', 'SpeechTokenIdUserLexicon',
    'DISPID_SRCRetainedAudio', 'DISPID_SDKCreateKey',
    'SRSEIsSpeaking', 'SPEI_UNDEFINED', 'SpeechLoadOption',
    'SDTPronunciation', 'SPINTERFERENCE_NOISE', 'SRERequestUI',
    'ISpXMLRecoResult', 'SAFTCCITT_ALaw_8kHzStereo',
    'SAFT44kHz8BitMono', 'ISpeechRecoResult2', 'DISPID_SOTCId',
    'SPVPRI_ALERT', 'SRAExport', 'DISPID_SPAsItem',
    'DISPID_SRCEAdaptation', 'SVP_16', 'DISPID_SGRSTType',
    'DISPID_SPRFirstElement', 'DISPID_SLGetGenerationChange',
    'SpeechStreamFileMode', 'DISPID_SRCEPropertyNumberChange',
    'SWPUnknownWordUnpronounceable', 'ISpRecoResult', 'SVP_18',
    'SPWT_PRONUNCIATION', 'SAFTGSM610_22kHzMono', 'SPSModifier',
    'SpeechLexiconType', 'SRATopLevel', 'DISPID_SVSpeak',
    'SAFT8kHz8BitStereo', 'SPDATAKEYLOCATION',
    'DISPID_SRCEFalseRecognition', 'DISPID_SWFEFormatTag',
    'SpMMAudioIn', 'ISpeechPhraseAlternate',
    'SpeechRegistryLocalMachineRoot', 'SPEI_TTS_PRIVATE',
    'ISpPhoneConverter', 'SAFT8kHz16BitMono',
    'DISPID_SDKSetStringValue', 'DISPID_SPIAudioStreamPosition',
    'ISpEventSource', 'SpeechTokenValueCLSID',
    'DISPID_SDKSetBinaryValue', 'DISPID_SBSRead',
    'DISPID_SOTCategory', 'SRSActive', 'SPCT_DICTATION',
    'SAFT44kHz16BitStereo', 'SPFM_OPEN_READWRITE',
    'DISPID_SVEPhoneme', 'DISPID_SGRsAdd', 'SAFTADPCM_44kHzMono',
    'DISPID_SVEWord', 'SECFIgnoreCase',
    'DISPID_SLRemovePronunciation', 'ISpeechPhraseElement',
    'SPCS_DISABLED', 'DISPID_SRCEPropertyStringChange',
    'SPEVENTSOURCEINFO', 'DISPID_SVAlertBoundary', 'ISpRecognizer2',
    'DISPID_SRCBookmark', 'DISPID_SPEAudioSizeTime',
    'DISPID_SPISaveToMemory', 'SAFTCCITT_ALaw_44kHzMono',
    'SGDSInactive', 'ISpResourceManager', 'SPBO_NONE', 'SP_VISEME_2',
    'SAFT12kHz16BitStereo', 'ISpeechVoiceStatus', 'SPWT_DISPLAY',
    'DISPID_SpeechMMSysAudio', 'DISPID_SMSSetData', 'SGSDisabled',
    'SPPS_RESERVED1', 'ISpPhraseAlt', 'DISPID_SpeechObjectToken',
    'SP_VISEME_4', 'ISpeechPhraseReplacement', 'DISPID_SRCVoice',
    'ISpeechDataKey', 'DISPID_SRCEStartStream', 'eLEXTYPE_PRIVATE18',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SLWType', 'SpeechRecoContextState',
    'DISPID_SpeechGrammarRuleStateTransition', 'SPSHT_Unknown',
    'SAFT16kHz8BitMono', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SLPPartOfSpeech', 'STCLocalServer',
    'DISPID_SVGetProfiles', 'Speech_Max_Word_Length',
    'DISPID_SRGCmdLoadFromObject', 'STCRemoteServer',
    'SPSHT_NotOverriden', 'SPPS_Interjection', 'SRERecognition',
    'DISPID_SAStatus', 'DISPID_SVSInputWordLength',
    'DISPID_SPPNumberOfElements', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SRCEInterference', 'SAFTTrueSpeech_8kHz1BitMono',
    'eLEXTYPE_PRIVATE15', 'SDTDisplayText', 'SGRSTTTextBuffer',
    'ISpeechPhraseElements', 'DISPID_SASetState',
    'SAFTCCITT_uLaw_44kHzMono', 'SECFIgnoreWidth',
    'SPEI_END_INPUT_STREAM', 'DISPID_SRGDictationSetState',
    'ISpStreamFormatConverter', 'DISPID_SRCEventInterests',
    'SGRSTTWildcard', 'DISPID_SPPs_NewEnum', 'DISPID_SRRTLength',
    'SPBO_AHEAD', 'SpeechVoicePriority', 'DISPID_SRCreateRecoContext',
    'ISpAudio', 'SPEI_START_INPUT_STREAM', 'SVSFIsNotXML', 'SVP_0',
    'SPEI_PHONEME', 'SpeechSpecialTransitionType', 'DISPID_SBSWrite',
    'DISPID_SRCESoundEnd', 'SpeechAudioVolume',
    'DISPID_SVSLastBookmark', 'DISPID_SRGetRecognizers',
    'SpeechGrammarTagWildcard', 'ISpGrammarBuilder', 'SPPS_Verb',
    'SP_VISEME_11', 'SPAO_RETAIN_AUDIO', 'DISPID_SVEStreamStart',
    'SAFT16kHz16BitMono', 'SPCATEGORYTYPE',
    'DISPID_SpeechPhraseAlternate', 'SAFTGSM610_8kHzMono',
    'SPEI_MIN_TTS', 'SP_VISEME_7', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SVEStreamEnd', 'SREStreamStart',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SREPhraseStart',
    'SPAUDIOBUFFERINFO', 'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SRCAudioInInterferenceStatus', 'SPRST_ACTIVE', 'SPAR_Low',
    'DISPID_SpeechLexiconPronunciation', 'SPDKL_CurrentUser',
    'SFTInput', 'SpeechRecognitionType', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SFSOpen', 'DISPID_SPAs_NewEnum', 'SPWORD', 'SASStop',
    'SPWORDPRONUNCIATIONLIST', 'SpeechRetainedAudioOptions',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SRCESoundStart',
    'SPCT_SLEEP', 'DISPID_SVSCurrentStreamNumber', 'SVSFUnusedFlags',
    'DISPID_SPERetainedStreamOffset',
    'ISpeechGrammarRuleStateTransition', 'STCInprocServer',
    'SRCS_Enabled', 'SGDSActiveWithAutoPause',
    'DISPID_SPEEngineConfidence', 'DISPID_SASCurrentSeekPosition',
    'SRTStandard', 'SAFT32kHz16BitMono', 'SAFTADPCM_8kHzMono',
    'DISPID_SOTIsUISupported', 'SRSActiveAlways', 'SPEI_HYPOTHESIS',
    'DISPID_SpeechMemoryStream', 'SREAudioLevel',
    'DISPID_SpeechRecoContextEvents', 'SVP_7',
    'SPINTERFERENCE_TOOSLOW', 'IInternetSecurityManager',
    'STCInprocHandler', 'SPRULESTATE', 'SpeechAudioProperties',
    'SpeechTokenKeyFiles', 'DISPID_SVSLastBookmarkId',
    'DISPID_SVSInputSentencePosition', 'DISPID_SVDisplayUI',
    'SPSERIALIZEDRESULT', 'DISPID_SGRs_NewEnum',
    'DISPID_SPEs_NewEnum', 'DISPID_SRState', 'SLTUser', 'SWTAdded',
    'Speech_Default_Weight', 'SREPrivate', 'SRTSMLTimeout',
    'DISPID_SPRNumberOfElements', 'ISpeechGrammarRule',
    'SRAInterpreter', 'SRADynamic', 'SPSNotOverriden',
    'DISPID_SOTDataKey', 'DISPID_SOTRemove', 'SAFTGSM610_44kHzMono',
    'SPVPRI_OVER', 'DISPID_SPRuleId', 'SAFT22kHz16BitStereo',
    'SpeechCategoryRecoProfiles', 'SPGS_EXCLUSIVE', 'SVSFIsXML',
    'DISPID_SCSBaseStream', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SRCRetainedAudioFormat', 'SRAORetainAudio', 'SPSNoun',
    'SPINTERFERENCE', 'DISPID_SpeechObjectTokens',
    'DISPID_SRRecognizer', 'DISPID_SpeechPhraseBuilder',
    'SPPS_Function', 'eLEXTYPE_PRIVATE13', 'eLEXTYPE_RESERVED9',
    'SGRSTTDictation', 'SAFTADPCM_11kHzMono', 'DISPID_SWFEExtraData',
    'SPFILEMODE', 'DISPID_SLPPhoneIds', 'SVSFParseSapi',
    'ISpeechPhraseRules', 'UINT_PTR', 'SPBO_PAUSE',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SpVoice',
    'DISPID_SVEVoiceChange', 'SPEI_PHRASE_START', 'SpeechRunState',
    'DISPID_SpeechLexiconWords', 'ISpStream', 'SP_VISEME_8',
    'SAFT11kHz16BitStereo', 'SpeechAllElements', 'DISPID_SGRAddState',
    'eLEXTYPE_PRIVATE8', 'DISPID_SRRSpeakAudio',
    'DISPID_SVEventInterests', 'DISPID_SGRsCommitAndSave',
    'ISpeechAudioStatus', 'SGLexical', 'DISPID_SpeechCustomStream',
    'DISPID_SRCPause', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SPIProperties', 'SVPOver', 'DISPID_SPPEngineConfidence',
    'ISpLexicon', 'DISPID_SRCEPhraseStart', 'ISpeechRecoGrammar',
    'SpeechCategoryRecognizers', 'ISpeechRecoResultDispatch',
    'DISPID_SGRsItem', 'DISPID_SRRAlternates', 'DISPID_SGRSTsCount',
    'DISPID_SPAPhraseInfo', 'SpeechTokenShellFolder',
    'DISPID_SPIAudioSizeTime', 'SVP_5', 'DISPID_SASFreeBufferSpace',
    'DISPID_SABIMinNotification', 'DISPIDSPTSI_SelectionOffset',
    'ISpeechRecoResult', 'DISPID_SRRAudioFormat', 'DISPID_SGRSTRule',
    'DISPID_SPIEnginePrivateData', 'SPCS_ENABLED', 'SP_VISEME_3',
    'SREStreamEnd', 'DISPID_SOTSetId', 'SpUnCompressedLexicon',
    'DISPID_SRCCmdMaxAlternates', 'SPAS_CLOSED', 'SDTAlternates',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SPIAudioSizeBytes',
    'SSSPTRelativeToStart', 'DISPID_SMSALineId',
    'DISPID_SOTMatchesAttributes', 'DISPID_SpeechRecoContext',
    'DISPID_SDKDeleteValue', 'DISPID_SpeechRecognizerStatus',
    'SPPS_RESERVED4', 'SpeechCategoryAudioIn',
    'SPDKL_DefaultLocation', 'DISPID_SGRSAddSpecialTransition',
    'SPRST_INACTIVE_WITH_PURGE', 'SPWORDPRONUNCIATION',
    'SGLexicalNoSpecialChars', 'SRADefaultToActive',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SPACommit',
    'ISpeechObjectTokens', 'SPEVENTENUM', 'ISpObjectWithToken',
    'SPVISEMES', 'SRTReSent', 'SpeechCategoryAppLexicons',
    '_RemotableHandle', 'DISPID_SFSClose',
    'DISPID_SPEDisplayAttributes', 'SAFT24kHz16BitMono',
    'SVEAudioLevel', 'SREFalseRecognition', 'SPEI_ADAPTATION',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SAFTCCITT_uLaw_11kHzMono', 'SPEI_SENTENCE_BOUNDARY',
    'SP_VISEME_19', 'DISPID_SPRules_NewEnum', 'SpMemoryStream',
    'SPEI_FALSE_RECOGNITION', 'eLEXTYPE_LETTERTOSOUND', 'SPAS_PAUSE',
    'SAFTADPCM_22kHzStereo', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SPPName',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'eLEXTYPE_VENDORLEXICON', 'SpeechPartOfSpeech',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SVGetVoices',
    'DISPID_SVSLastResult', 'DISPID_SRIsUISupported', 'SVSFNLPMask',
    'ISpeechPhraseInfo', 'IEnumSpObjectTokens', 'SECFEmulateResult',
    'SPEI_VOICE_CHANGE', 'SAFT32kHz8BitStereo',
    'SAFTNoAssignedFormat', 'DISPID_SAFGuid', 'SpObjectToken',
    'DISPID_SpeechGrammarRule', 'SPPROPERTYINFO',
    'tagSPTEXTSELECTIONINFO', 'SpeechRecognizerState',
    'ISpStreamFormat', 'DISPID_SABufferNotifySize', 'SGRSTTWord',
    'SpShortcut', 'SWPKnownWordPronounceable',
    'SpeechBookmarkOptions', 'SpeechInterference', 'SASRun',
    'SpeechCategoryAudioOut', 'SPEI_END_SR_STREAM', 'ISpProperties',
    'SAFTCCITT_uLaw_44kHzStereo', 'STSF_LocalAppData',
    'DISPID_SpeechDataKey', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SPRuleEngineConfidence', 'ISpeechRecognizer',
    'DISPID_SRGCmdLoadFromMemory', 'SpeechGrammarWordType',
    'SpInprocRecognizer', 'DISPID_SLPsItem', 'SPPHRASEPROPERTY',
    'tagSTATSTG', 'DISPID_SOTDisplayUI', 'DISPID_SPEDisplayText',
    'ISpeechGrammarRuleState', 'DISPID_SGRSAddRuleTransition',
    'DISPID_SRCERecognition', 'SPPS_SuppressWord',
    'ISpeechWaveFormatEx', 'SpeechPropertyHighConfidenceThreshold',
    'SAFTCCITT_ALaw_11kHzStereo', 'SVEWordBoundary',
    'ISpeechRecognizerStatus', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SVAudioOutputStream', 'SPPHRASEELEMENT',
    'ISpeechAudioFormat', 'SP_VISEME_1', '__MIDL_IWinTypes_0009',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SpeechAudioStatus',
    'eLEXTYPE_RESERVED8', 'DISPID_SPAStartElementInResult',
    'DISPID_SPPChildren', 'SPEI_START_SR_STREAM', 'SVP_20',
    'DISPID_SPPsItem', 'SPXRO_SML',
    'SpeechPropertyComplexResponseSpeed', 'DISPIDSPTSI',
    'SPWF_SRENGINE', 'SSFMOpenForRead',
    'DISPID_SpeechPhraseProperties', 'SPFM_CREATE_ALWAYS', 'SPSLMA',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SPEsItem',
    'SpWaveFormatEx', 'SPGS_DISABLED', 'DISPID_SVGetAudioInputs',
    'DISPID_SRSAudioStatus', 'SRSEDone', 'SREStateChange',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SRGetFormat',
    'SGDSActiveUserDelimited', 'ISpeechPhraseProperties',
    'SpeechRecoProfileProperties', 'DISPID_SGRInitialState',
    'SpeechWordType', 'eLEXTYPE_PRIVATE16', 'SpeechRegistryUserRoot',
    'SpeechCategoryPhoneConverters',
    'ISpeechTextSelectionInformation', 'DISPID_SPEActualConfidence',
    'DISPIDSPTSI_ActiveLength', 'ISpNotifySink', 'SLTApp',
    'DISPID_SpeechPhraseReplacement', 'SPADAPTATIONRELEVANCE',
    'SPBO_TIME_UNITS', 'DISPID_SRRTTickCount', 'SECFIgnoreKanaType',
    'DISPID_SOTGetStorageFileName', 'SPCONTEXTSTATE', 'SPPS_Noun',
    'DISPID_SpeechPhraseInfo', 'SPAS_RUN', 'eLEXTYPE_PRIVATE14',
    'SAFTNonStandardFormat', 'SpeechVoiceEvents', 'SpLexicon',
    'SVEPrivate', 'eLEXTYPE_PRIVATE2', 'SpInProcRecoContext',
    'SAFT16kHz8BitStereo', 'SDTAudio', 'SAFT16kHz16BitStereo',
    'DISPID_SDKEnumKeys', 'SDKLCurrentConfig', 'eLEXTYPE_RESERVED7',
    'DISPID_SVSRunningState', 'DISPID_SADefaultFormat',
    'SpeechPropertyResponseSpeed', 'SpSharedRecoContext', 'SINone',
    'DISPID_SpeechAudioBufferInfo', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SOTsItem'
]

_check_version('1.2.0', 1738517464.176643)
